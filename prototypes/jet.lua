...
function createJet(name, order)
	...
	jI.type = "item"
	jI.name = name
	jI.icon = "__Mobile_Factory-Jets__/graphics/jets/" .. name .. "I.png"
	jI.icon_size = 64
	jI.subgroup = "Jet"
    jI.order = order
	jI.stack_size = 20
	...
	jT.name = name
	jT.type = "technology"
	jT.icon = "__Mobile_Factory-Jets__/graphics/jets/" .. name .. "T.png"
	jT.icon_size = 400
	jT.unit = {
	count=8,
	time=130,
	...
	jU.name = name
	jU.type = "unit"
	jU.icon = "__Mobile_Factory-Jets__/graphics/jets/" .. name .. "I.png"
	jU.icon_size = 64
	jU.order = order
		...
		{
			{
				frame_count = 1,
				direction_count = 24,
				filename = "__Mobile_Factory-Jets__/graphics/jets/" .. name .. "E.png",
				width = 400,
				height = 250,
				shift = {0,0},
				scale = 1/5,
			...
			},
			{
				frame_count = 1,
				direction_count = 24,
				filename = "__Mobile_Factory-Jets__/graphics/jets/JetS.png",
				width = 400,
				height = 250,
				draw_as_shadow = true,
				shift = {0.2,3},
